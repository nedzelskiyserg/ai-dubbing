...
# Скрипт для запуска React фронтенда и Python API сервера в полноэкранном режиме

echo "🚀 Запуск AI Dubbing Studio..."
...
# Пробуем браузеры в kiosk mode (лучший вариант)
ARC_PATH=""
CHROME_PATH=""
EDGE_PATH=""
CHROMIUM_PATH=""
...
trap "kill $API_PID $REACT_PID $FULLSCREEN_PID 2>/dev/null; exit" EXIT INT TERM
